...
- [AIWorkbench](https://aiworkbench.eu/) – Local-first AI assistant for independent professionals. Connects read-only to your own mailbox, files mail into projects, and generates a storyboard, tasks, contacts, and reply drafts. Bring your own model — LM Studio / Ollama / vLLM / Anthropic / any OpenAI-compatible endpoint.
